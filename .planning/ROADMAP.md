...
- [ ] **Phase 7: Стекло и заголовки** - Полупрозрачное стекло карточек About, Involve и ресурсов по CSS оригинала, плоские белые заголовки секций, градиент только у About
- [ ] **Phase 8: Лента карты и дышащие огоньки** - Карта и форма на одной скошенной подложке без второй линии среза, огоньки с дышащим свечением в пяти корзинах, карта без reveal
- [ ] **Phase 9: Форма как в оригинале** - Форма без карточки-обёртки, тип света не выбран при старте, поле «Название организации» для группы, русские подписи и стили полей оригинала
- [ ] **Phase 10: Превью новостей и видео** - Карточки новостей 16:9 без чёрных полос с панелью заголовка и ховером оригинала, превью роликов без полос
- [ ] **Phase 11: Ресурсы: сетка, карточки, панели** - Сетка 320/528/272, карточки с индикатором и подчёркиванием, полноэкранные панели со шторным переходом и наполнением ЕАД плюс английские материалы
- [ ] **Phase 12: Футер в одну колонку** - Логотип, подпись, ссылки столбиком и юридический текст по центру без разделительной линии
- [ ] **Phase 13: Интеграция, гейт и приёмка** - Слияние фаз 7–12, полный гейт, деплой и Playwright-сравнение с оригиналом на 1440×900 и 390×844
...
| 7. Стекло и заголовки | v1.1 | 0/0 | Not started | - |
| 8. Лента карты и дышащие огоньки | v1.1 | 0/0 | Not started | - |
| 9. Форма как в оригинале | v1.1 | 0/0 | Not started | - |
| 10. Превью новостей и видео | v1.1 | 0/0 | Not started | - |
| 11. Ресурсы: сетка, карточки, панели | v1.1 | 0/0 | Not started | - |
| 12. Футер в одну колонку | v1.1 | 0/0 | Not started | - |
| 13. Интеграция, гейт и приёмка | v1.1 | 0/0 | Not started | - |

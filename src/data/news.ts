...
export const news: NewsItem[] = [
  {
    ...
    source: YOUTUBE,
    // Кадр 2,41:1: в постере 94 строки поля сверху и 67 снизу (содержимое 94…293 из 360,
    // центр на 193,5). object-position 65% ставит центр окна 16:9 на строку 193,5,
    // масштаб 1,45 оставляет видимыми 186 строк — 100…287, внутри содержимого.
    coverZoom: 1.45,
    coverPosition: "50% 65%",
  },
  {

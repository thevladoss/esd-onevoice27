...
/**
 * Живой регион успеха: смонтирован всегда и пуст до отправки, поэтому скринридер читает
 * сообщение как смену содержимого уже существующего региона, а не как появление нового узла.
 * Фокус остаётся там, где его оставил посетитель.
 */
export function SuccessLiveRegion({ message }: { message: string }) {
  return (
...
/**
 * Визуальная копия успеха. Объявление скринридеру делает `SuccessLiveRegion`, поэтому карточка

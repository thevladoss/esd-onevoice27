  ...
  return (
    <header ref={headerRef} className={headerClass}>
      <div className="site-header__content">
        ...
        {/* Оверлей живёт внутри пилюли, как в оригинале, и делит стековый контекст
            ландмарки: так бургер (z-index 42) остаётся поверх оверлея (z-index 40),
            меню закрывается крестом, а логотип и стекло уходят под оверлей. */}
        <MobileMenu
          open={menuOpen}
          onClose={closeMenu}
          onNavigate={navigate}
